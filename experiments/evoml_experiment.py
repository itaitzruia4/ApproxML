...
from approxml.sample import (
    ...
    CosSimSamplingStrategy,
    RandomSamplingStrategy,
)

# switch conditions
from approxml.switch import CosSimSwitchCondition, CVErrorSwitchCondition
...
def main():
    ...
    if len(sys.argv) < 8:
        print(
            "Usage: python3 evoml_experiment.py <job_id> <problem> <model> <switch_method> <threshold> <sample_strategy> <sample_rate>"
        )
        exit(1)
